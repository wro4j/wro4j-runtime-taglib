...
public class VersionedResourceUriStrategyTest extends ResourceUriStrategyTestBase {
  ...
  private static final String EXPECTED_LOCAL_URI =
    CONTEXT_PATH + ROOT + VERSIONED_NAME + "." + RESOURCE_TYPE.name().toLowerCase();
  ...
  @BeforeMethod
  public void setUp() {
    versionedResourceUriStrategy = new VersionedResourceUriStrategy(
      CONTEXT_PATH,
      getOptimizedResourcesRootStrategy(),
